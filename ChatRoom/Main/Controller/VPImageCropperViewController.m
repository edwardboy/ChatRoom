...
- (UIButton *)cancelBtn{
    if (!_cancelBtn){
        ...
        [cancelBtn addTarget:self action:@selector(confirm:) forControlEvents:UIControlEventTouchUpInside];
...
- (UIButton *)confirmBtn{
    if (!_confirmBtn) {
        UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50.0f, 100, 50)];
